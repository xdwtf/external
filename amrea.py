...
@bot.on_message(filters.chat(TARGET_CHAT_ID), group=4)  # Listening to messages from the specified channel
async def url_replacement_handler(bot: BOT, message: Message):
    text_to_check = None

    # If the message has a photo and a caption, check caption
